...
def app(df, x, y):
    ...
    with col1:
        st.image(
            "https://images.squarespace-cdn.com/content/v1/61eeea89d60f57793d9e114b/1706854176756-Y4XKV9Q0OQ5F2C0ICPDI/iris%2Bsetosa%2B%25282%2529.jpg?format=1000w.jpg",
            caption="Iris Setosa",
            width=150
        )
    with col2:
